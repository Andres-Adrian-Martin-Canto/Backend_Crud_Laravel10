...
class ValidacionCostosVariables implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        $costos_fijos = $estudio->costos_variables;
        /**
         * Luego recorro todos los costos variables para encontrar si
         * ya esta ocupado ese mes.
         */
        foreach ($costos_fijos as $costo_fijo) {
            // Si lo encuentra regresa un error.
            if($costo_fijo->month == $value) {
                $fail("Ese mes ya esta ocupado por otro costo variable");
            }
        }
    }
}
